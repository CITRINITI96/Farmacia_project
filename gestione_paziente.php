        ...
        <table>
            ...
            <?php foreach ($pazienti as $paziente): ?>
                <tr>
                    ...
                    <!-- Pulsante per gestire le prescrizioni -->
                    <td>
                        <a href="gestione_prescrizione.php?id=<?= $paziente['ID_Paziente'] ?>" class="button">Gestione Prescrizione</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
